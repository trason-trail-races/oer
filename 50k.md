...
<p class="lead">Run along the middle fork of the American River via Tevis Cup Trail and enjoy Ann Trason's favorite views. Great first time ultra. Cross No Hands Bridge before finishing in Auburn.<br>
<br>
Elevation gain and loss: 7,000' gain / 9,200' loss</p>
...
You can also <a href="{{ site.url }}/assets/tracks/overlook50k-data2.gpx">download the .gpx file</a> to import into your GPS device or to generate a <a href="http://www.gpsvisualizer.com/map_input?form=google">GPSVisualizer map</a>.
