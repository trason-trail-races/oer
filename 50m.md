...
You can also <a href="{{ site.url }}/assets/tracks/overlook50m-data2.gpx">download the .gpx file</a> to import into your GPS device or to generate a <a href="http://www.gpsvisualizer.com/map_input?form=google">GPSVisualizer map</a>.
